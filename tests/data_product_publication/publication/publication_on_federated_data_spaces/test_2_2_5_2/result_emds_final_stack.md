...
This result introduces an **EMDS Final Stack** perspective for the existing test `2.2.5.2` under the KPI1 area **Publication on federated data spaces**.
