...
const descriptions = [
    "Data Product preparation: Before publishing, data owners or data providers must ensure their data asset is suitable for inclusion in a data product offering.",
